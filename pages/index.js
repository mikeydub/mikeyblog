  ...
  return (
    <div className="flex h-screen">
      <div className="my-auto ml-4 md:ml-32 lg:ml-80">
        ...
        <p className="mt-2 text-sm w-96 leading-6">Making a dent. Pursuing the greater good. Trying my best. Founder of <a className="hover:text-gray-400 hover:underline" href="https://gallery.so/mikey">Gallery.</a> <a className="hover:text-gray-400 hover:underline" href="https://twitter.com/mikeybitcoin">Twitter.</a> <a className="hover:text-gray-400 hover:underline" href="https://instagram.com/mikeybitcoin">Insta.</a></p>
